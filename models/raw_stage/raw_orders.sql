SELECT
    ...
    CASE WHEN a.L_SHIPDATE > '{{ var('load_date') }}' THEN NULL ELSE a.L_SHIPDATE END AS SHIPDATE,
    CASE WHEN a.L_COMMITDATE > '{{ var('load_date') }}' THEN NULL ELSE a.L_COMMITDATE END AS COMMITDATE,
    CASE WHEN a.L_RECEIPTDATE > '{{ var('load_date') }}' THEN NULL ELSE a.L_RECEIPTDATE END AS RECEIPTDATE,
